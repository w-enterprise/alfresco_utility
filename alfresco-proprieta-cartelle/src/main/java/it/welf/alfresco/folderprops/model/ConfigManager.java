...
public class ConfigManager {
    private static final String CONFIG_FILE = "alfresco_folderprops_config.properties";
    private static final String KEY = "WelfAlfrescoFld!"; // 16 chars for AES-128
    ...
    public void saveConfig(String address, String username, String password) throws Exception {
        ...
        try (OutputStream out = Files.newOutputStream(configPath)) {
            props.store(out, "Alfresco Proprieta Cartelle Configuration");
        }
    }
